...
//! `packages/openapi` (S6+ W2). Endpoint code-sample generation
...
use apitoolchain_uniform::Reference;
...
// resolving unchanged, and the re-export keeps `apitoolchain_openapi::DocCtx` — the
