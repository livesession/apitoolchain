...
//! `openapi::core::schema_object_to_property` — the same function the JS
//! impl borrows from `@xyd-js/openapi`.

use serde_json::{json, Map, Value};

use openapi::core::{schema_object_to_property, VisitedRefs};
use openapi::DocCtx;
...
fn json_schema_properties_to_definition_properties(schema: Option<&Value>) -> Vec<Value> {
    ...
    for name in uniform::jsrt::js_object_keys(props) {
